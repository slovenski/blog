/**
 * [Modified]
 * Base on https://github.com/system-ui/theme-ui/blob/47e22668baff902fdca524d63e446afa78def9a0/packages/theme-ui/src/custom-properties.js
 */
const toVarName = key => `--svarga-theme-ui-${key}`;
...
export const createColorModeStyles = modes => {
  ...
  Object.keys(modes).forEach(mode => {
    const key = `&.svarga-theme-ui-${mode}`;
